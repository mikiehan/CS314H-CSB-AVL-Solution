 ...
 */
public class AVLTreeTextbook<AnyType extends Comparable<? super AnyType>>
{
     ...
     */
    private AvlNode<AnyType> singleRotateWithLeftChild(AvlNode<AnyType> k2 ) {
     ...
     * Update heights, then return new root.
     */
    private AvlNode<AnyType> singleRotateWithRightChild(AvlNode<AnyType> k1 ) {
